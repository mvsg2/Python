...
# playlist = Playlist(url='https://www.youtube.com/playlist?list=PLWcODnEVd5usT6sbQsQ9lnffLGHBCrcEH')
# print()
...
# print(playlist.length) # the same as print(len(playlist.video_urls))
# print(playlist.views_count)
# print(playlist.likes_count)


# donwload_folder = 'E:/YouTube_Downloads/Walt Disney/'
...
#     video.streams.get_highest_resolution().download(output_path=donwload_folder)
